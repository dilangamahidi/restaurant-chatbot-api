...
TRANSLATIONS = {
    ...
    'ta': {
        ...
        # Reservation Messages (Basic Tamil)
        ...
        'invalid_time': 'மன்னிக்கவும், நாங்கள் {time}க்கு திறந்திருக்கவில்லை. எங்கள் உணவகம் காலை 9:00 முதல் இரவு 9:00 வரை திறந்திருக்கிறது. தயவுசெய்து காலை 9 முதல் இரவு 9 வரையிலான நேரத்தைத் தேர்வுசெய்யவும்.',
        ...
        'multiple_reservations': 'உங்களுக்கு {count} முன்பதிவுகள் உள்ளன. எதை மாற்ற வேண்டும் என்பதைக் குறிப்பிட {phone} என்ற எண்ணில் அழைக்கவும்.',
        'current_reservation': '📋 உங்கள் தற்போதைய முன்பதிவு: {date} அன்று {time}க்கு {guests} நபர்களுக்கு {name} (மேஜை {table}). நீங்கள் எதை மாற்ற விரும்புகிறீர்கள்?',
        ...
        'datetime_needed_table': 'மேஜை {table} கிடைக்கும் தன்மையை சரிபார்க்க எனக்கு தேதி மற்றும் நேரம் தேவை.',
        ...
        'update_error': 'புதுப்பிப்பு முடிந்தது. மாற்றங்களை உறுதிப்படுத்த {phone} என்ற எண்ணில் அழைக்கவும்.',
        'cancel_error': 'மன்னிக்கவும், உங்கள் முன்பதிவை ரத்து செய்வதில் சிக்கல் ஏற்பட்டது. தயவுசெய்து {phone} என்ற எண்ணில் அழைக்கவும்.',
        ...
        'reservation_cancelled': '✅ முன்பதிவு வெற்றிகரமாக ரத்து செய்யப்பட்டது!',
        ...
        'contact_staff': '👨‍💼 எங்கள் பணியாளர்களைத் தொடர்புகொள்ளுங்கள்:',
        'location_header': '📍 {restaurant} இடம்:',
